...
<body >
    ...
    <script>
        $(document).ready(function(){
            console.log("Hi")
            $.ajax({
                url : 'http://localhost:8080/WebSach/api/lichsudoc/',
                type : 'get',
                dataType : 'json',
                success : function (result){
                    ...
                    html+='<li>';
                        html+='<div class="anh_sach">'
                            html+='<a href="http://localhost:8080/WebSach/doctruyen/'+value['ten_khong_dau']+'"><img class="center" src="'+"/WebSach/static/img/"+value['img']+'" alt="'+value['TenSach']+'" style=""></a>';
                            html+='<div class="thongtin_sach">';
                                html+='<div class="ten_sach qtip" data-qtip="#truyen-tranh-12139">';
                                    html+='<h3><a title="'+value['TenSach']+'" href="http://localhost:8080/WebSach/doctruyen/'+value['ten_khong_dau']+'">'+value['TenSach']+'</a></h3>';
                                html+='</div>';
